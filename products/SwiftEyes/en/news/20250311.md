---
title: Swift Eye Has Been Released
layout: plain-en
---
Published on March 11, 2025

Swift Eye, an AI image recognition app for iPhone, has been released.

Swift Eye is an AI-powered image recognition app designed to support people with visual impairments. It analyzes images taken with the camera or shared from apps like Photos, and provides a text description of the content. Because it is optimized for the VoiceOver screen reader, it automatically reads the text aloud once the analysis is completed.
...
[Swift Eye on the App Store](https://apps.apple.com/us/app/swift-eyes/id6742831929)
