...
Swift Eye is an iPhone app designed to assist people with visual impairments. It uses AI to analyze images taken with the camera or shared from apps like Photos, and then communicates the contents as text.  
Because Swift Eye is optimized for the VoiceOver screen reader, the text is read aloud automatically once the analysis is complete. You can also save the image back to the Photos app with the analysis text embedded as a caption.  
...
Swift Eye is available in both free and paid editions. The differences are:
...
[News from Swift Eye](https://moutend.github.io/products/SwiftEyes/en/news/)
...
[Swift Eye App Feedback Form](https://docs.google.com/forms/d/e/1FAIpQLSdoLmKot6JKojLeA82mOkxv3KDluY2LvMeDaxdinACedSS0pg/viewform?usp=dialog)
